...
public final class MathListFragment_
    extends com.example.gaidamak.helper.MathListFragment
    implements HasViews, OnViewChangedListener
{
    ...
    public void onCreateOptionsMenu(Menu menu, MenuInflater inflater) {
        inflater.inflate(com.example.gaidamak.helper.R.menu.fragment_term_list_menu, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (itemId_ == com.example.gaidamak.helper.R.id.addItem) {
            addItem();
            return true;
        }
        return false;
    ...
    public static class FragmentBuilder_
        extends FragmentBuilder<MathListFragment_.FragmentBuilder_, com.example.gaidamak.helper.MathListFragment>
    {


        @Override
        public com.example.gaidamak.helper.MathListFragment build() {
