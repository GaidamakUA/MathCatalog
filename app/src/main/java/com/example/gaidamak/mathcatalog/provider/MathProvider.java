...
public class MathProvider extends ContentProvider {
    private static final String TAG = MathProvider.class.getSimpleName();
    ...
    public static final String AUTHORITY = "com.example.gaidamak.mathcatalog.provider";
    public static final String CONTENT_URI_BASE = "content://" + AUTHORITY;

    public static final String QUERY_NOTIFY = "QUERY_NOTIFY";
    public static final String QUERY_GROUP_BY = "QUERY_GROUP_BY";

    private static final int URI_TYPE_MATH_TERM = 0;
    private static final int URI_TYPE_MATH_TERM_ID = 1;
    ...
    static {
        URI_MATCHER.addURI(AUTHORITY, MathTermColumns.TABLE_NAME, URI_TYPE_MATH_TERM);
        URI_MATCHER.addURI(AUTHORITY, MathTermColumns.TABLE_NAME + "/#", URI_TYPE_MATH_TERM_ID);
    }

    protected MathSQLiteOpenHelper mMathSQLiteOpenHelper;
    ...
    public boolean onCreate() {
        ...
        mMathSQLiteOpenHelper = MathSQLiteOpenHelper.getInstance(getContext());
        return true;
    }
    ...
    public String getType(Uri uri) {
        ...
        switch (match) {
            case URI_TYPE_MATH_TERM:
                return TYPE_CURSOR_DIR + MathTermColumns.TABLE_NAME;
            case URI_TYPE_MATH_TERM_ID:
                return TYPE_CURSOR_ITEM + MathTermColumns.TABLE_NAME;
    ...
    public Uri insert(Uri uri, ContentValues values) {
        ...
        long rowId = mMathSQLiteOpenHelper.getWritableDatabase().insertOrThrow(table, null, values);
    ...
    public int bulkInsert(Uri uri, ContentValues[] values) {
        ...
        String table = uri.getLastPathSegment();
        SQLiteDatabase db = mMathSQLiteOpenHelper.getWritableDatabase();
        int res = 0;
        db.beginTransaction();
        try {
    ...
    public int update(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        int res = mMathSQLiteOpenHelper.getWritableDatabase().update(queryParams.table, values, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        QueryParams queryParams = getQueryParams(uri, selection, null);
        int res = mMathSQLiteOpenHelper.getWritableDatabase().delete(queryParams.table, queryParams.selection, selectionArgs);
        String notify;
        if (res != 0 && ((notify = uri.getQueryParameter(QUERY_NOTIFY)) == null || "true".equals(notify))) {
            getContext().getContentResolver().notifyChange(uri, null);
        }
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        Cursor res = mMathSQLiteOpenHelper.getReadableDatabase().query(queryParams.tablesWithJoins, projection, queryParams.selection, selectionArgs, groupBy,
    ...
    private QueryParams getQueryParams(Uri uri, String selection, String[] projection) {
        ...
        switch (matchedId) {
            case URI_TYPE_MATH_TERM:
            case URI_TYPE_MATH_TERM_ID:
                res.table = MathTermColumns.TABLE_NAME;
                res.tablesWithJoins = MathTermColumns.TABLE_NAME;
                res.orderBy = MathTermColumns.DEFAULT_ORDER;
                break;
